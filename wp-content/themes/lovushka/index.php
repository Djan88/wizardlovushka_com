              ...
              <div class="row">
                ...
                <div class="col-md-4 col-md-offset-4">
                  <div class="btn-group speed_control">
                    ...
                    <button type="button" class="btn btn-default btn-lg disabled speed_closed hidden"><i class="fa fa-backward" aria-hidden="true"></i></button>
                    ...
                    <button type="button" class="btn btn-default btn-lg disabled speed_closed hidden"><i class="fa fa-forward" aria-hidden="true"></i></button>
                  </div>
                </div>
                <div class="col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2 col-xs-12">
                  <div class="btn-group speed_control">
